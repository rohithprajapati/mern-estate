        ...
        <form className='flex flex-col sm:flex-row gap-4'>
            ...
            <div className='flex flex-col flex-1 gap-4'>
                ...
                <div className='flex gap-4'>
                    ...
                    <button className='uppercase p-3 text-green-700 border-green-700 border rounded hover:shadow-lg disabled:opacity-80'>Upload</button>
                </div>
            <button className='p-3 bg-slate-700 uppercase text-white rounded-lg hover:opacity-95 disabled:opacity-80'>Create Listing</button>
            </div>
        </form>
